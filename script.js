...
const questions=[
    {
        q:'Hepatitis is the inflammation of which part of the body?',
        options: ['Lungs','Kidney','Liver','Bladder'],
        answer: 2 
    },
    {
        q:'In human body, aorta carries blood from which organ?',
        options: ['Capillary','Heart','Liver','Pulmonary Vein'],
        answer: 1 
    },
    {
        q:'One of these is not a symptom of COVID-19:',
        options: ['Stooling','Fever','Cough','Difficulty in breathing'],
        answer: 0 
    },
    {
        q:'How many pairs of ribs does an adult human have?',
        options: ['12','10','6','11'],
        answer: 0 
    },
    {
        q:'Medically, Septicaemia is more commonly known as?',
        options: ['Blood Overflow','Food Poisoning','Blood Shortage','Blood Poisoning'],
        answer: 3 
    }
]
